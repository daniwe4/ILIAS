...
class ilObjLearningSequence extends ilContainer
{
    ...
    protected function cloneAutoGeneratedRoles(ilObject $new_obj) : bool
    {
    ...
    protected function cloneSettings(ilObject $new_obj) : void
    {
    ...
    protected function cloneActivation(ilObject $new_obj, int $a_copy_id) : void
    {
        // #14596
    ...
    ***************************************************************************/
    ...
    public function getLearningSequenceMemberData(array $a_mem_ids, int $active = 1) : array
    {
