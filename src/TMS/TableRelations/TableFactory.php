...
class TableFactory {
	...
	public function concatString($name, Filters\Predicates\Field $field, $append = "")
	{
		return new Tables\DerivedFields\ConcatString($this->predicate_factory, $name, $field, $append);
	}
	 ...
	 */
	public function constString(string $name, string $value = '')
	{
