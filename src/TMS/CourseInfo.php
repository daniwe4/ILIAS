...
interface CourseInfo extends Component
{
    ...
    const CONTEXT_USER_BOOKING_SUPERIOR_FURTHER_INFO = 8;
    const CONTEXT_ADMIN_OVERVIEW_FURTHER_INFO = 9;
    const CONTEXT_ASSIGNED_TRAINING_DETAIL_INFO = 12;
    const CONTEXT_ASSIGNED_TRAINING_FURTHER_INFO = 13;
    ...
    const CONTEXT_APPROVALS_OVERVIEW = 22;
    const CONTEXT_TEP_SESSION_DETAILS = 23;
