 ...
 */
class ilObjWebinar extends ilObjectPlugin implements ilLPStatusPluginInterface
{
    ...
    /**
     * @var Webinar\VC\DataImport[]
     */
    protected $vc_imports = array();

    /**
     * @var Webinar\VC\DataExport[]
     */
    protected $vc_exports = array();

    /**
     * @var Webinar\VC\FileStorage[]
     */
    protected $vc_storages = array();

    /**
     * @var Webinar\VC\FormHelper[]
     */
    ...
    {
        $this->createUnboundProvider("crs", CaT\Plugins\Webinar\UnboundProvider::class, __DIR__ . "/UnboundProvider.php");
        $this->createUnboundProvider("crs", CaT\Plugins\Webinar\SharedUnboundProvider::class, __DIR__ . "/SharedUnboundProvider.php");
    ...
    public function getActions()
    {
        if ($this->actions === null) {
            $this->actions = new Webinar\ilActions($this, $this->getSettingsDB(), $this->getParticipantsDB(), new Webinar\LPSettings\LPManagerImpl());
        }
    ...
    public function getVCActions()
    {
        ...
        if (!array_key_exists($vc_type, $this->vc_actions)) {
            $db_string = "\\CaT\\Plugins\\Webinar\\VC\\" . $vc_type . "\\ilDB";
            $class_string = "\\CaT\\Plugins\\Webinar\\VC\\" . $vc_type . "\\ilActions";
    ...
    public function getImport()
    {
        ...
        if (!array_key_exists($vc_type, $this->vc_imports)) {
            $class_string = "\\CaT\\Plugins\\Webinar\\VC\\" . $vc_type . "\\Import";

            $this->vc_imports[$vc_type] = new $class_string(new Webinar\VC\PHPSpreadsheetParser());
        }
    ...
    public function getExport(ExcelWrapper\Writer $writer, ExcelWrapper\Spout\SpoutInterpreter $interpreter)
    {
        ...
        if (!array_key_exists($vc_type, $this->vc_exports)) {
            $class_string = "\\CaT\\Plugins\\Webinar\\VC\\" . $vc_type . "\\Export";
    ...
    public function getFileStorage()
    {
        ...
        if (!array_key_exists($vc_type, $this->vc_storages)) {
            $class_string = "\\CaT\\Plugins\\Webinar\\VC\\" . $vc_type . "\\FileStorageImpl";
    ...
    public function getVCFormHelper()
    {
        ...
        if (!array_key_exists($vc_type, $this->vc_form_helper)) {
            $class_string = "\\CaT\\Plugins\\Webinar\\VC\\" . $vc_type . "\\FormHelperImpl";
     ...
     * Get the settings
     *
     * @return Webinar\Settings\Webinar
     */
     ...
     *
     * @param Webinar\Settings\Webinar
     */
    public function setSettings(Webinar\Settings\Webinar $settings)
    {
     ...
     * Get db of settings
     *
     * @return \CaT\Plugins\Webinar\Settings\DB
     */
    public function getSettingsDB()
    {
        if ($this->settings_db === null) {
            global $DIC;
            $db = $DIC->database();
            $this->settings_db = new \CaT\Plugins\Webinar\Settings\ilDB($db);
        }
     ...
     *
     * @return \CaT\Plugins\Webinar\Participants\DB
     */
    public function getParticipantsDB()
    {
        if ($this->participants_db === null) {
            global $DIC;
            $db = $DIC->database();
            $this->participants_db = new \CaT\Plugins\Webinar\Participant\ilDB($db);
        }
     ...
     *
     * @return Webinar\LPSettings\LPManager
     */
    protected function getLPManager()
    {
        if ($this->lp_manager === null) {
            $this->lp_manager = new Webinar\LPSettings\LPManagerImpl();
        }
     ...
     *
     * @param Webinar\Settings\Webinar 	&$setings
     * @param mixed 	$config
     *
     * @return Webinar\Settings\Webinar
     */
    protected function updateCSNSettings(Webinar\Settings\Webinar &$settings, $config)
    {
     ...
     * @return void
     */
    protected function updateGenericSettings(Webinar\Settings\Webinar &$settings, $config)
    {
        $vc_actions = $this->getVCActions();
        $vc_settings = $vc_actions->select();
