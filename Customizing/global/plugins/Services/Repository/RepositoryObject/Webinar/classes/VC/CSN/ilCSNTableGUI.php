...
/**
 * Lists all participants of the csn vc.
 * Booked and unknown
 *
 * @author Stefan Hecken 	<stefan.hecken@concepts-and-training.de>
 */
class ilCSNTableGUI extends \ilTable2GUI
{
    ...
    public function __construct(
        ...
        \CaT\Plugins\Webinar\ilActions $actions,
        $parent_cmd = "",
        $template_context = ""
    ) {
        $this->setId("csn_member");
        ...
        $this->finished = $this->actions->getObject()->getSettings()->isFinished();
        ...
        $this->setTitle($this->txt("tbl_csn"));
        $this->setRowTemplate("tpl.csn_row.html", $this->vc_actions->getObject()->getDirectory());
