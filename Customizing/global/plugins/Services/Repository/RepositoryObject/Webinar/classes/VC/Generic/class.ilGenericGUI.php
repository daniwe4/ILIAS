...
use \CaT\Plugins\Webinar\VC\Generic;
...
class ilGenericGUI
{
    ...
    public function __construct(\ilParticipantGUI $parent, Generic\ilActions $vc_actions, \CaT\Plugins\Webinar\ilActions $actions)
    {
        $this->parent = $parent;
