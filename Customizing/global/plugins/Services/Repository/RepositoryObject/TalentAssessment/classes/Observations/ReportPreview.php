...
class ReportPreview
{
	...
	*/
	 ...
	 */
	public function draw($dest = '', $name = '')
	{
		$this->writer->AddPage();
		$this->drawTitle();
		$this->drawName();
	...
	{
		$this->writer->stringPositionedRelativeY(
			$this->summary_title_dy,
			$this->summary_title,
			'L',
			0,
			0,
	...
	{
		$this->writer->textPositionedNextLine(
			$this->summary,
			'L',
			$this->text_width,
			0,
