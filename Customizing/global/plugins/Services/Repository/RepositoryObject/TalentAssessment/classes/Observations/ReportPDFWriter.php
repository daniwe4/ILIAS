...
class ReportPDFWriter extends \fpdf implements ReportWriter
{
	...
	public function stringPositionedAbsolute(
		$x,
		$y,
		$text,
		$text_allign = 'L',
	...
	public function stringPositionedRelativeY(
		$y,
		$text,
		$text_allign = 'L',
		$w = 0,
	...
	public function textPositionedAbsolute(
		$x,
		$y,
		$text,
		$text_allign = 'L',
	...
	public function textPositionedRelativeY(
		$y,
		$text,
		$text_allign = 'L',
		$w = 0,
	...
	public function textPositionedNextline(
		$text,
		$text_allign = 'L',
		$w = 0,
		$h = 0,
	...
	public function stringPositionedNextline(
		$text,
		$text_allign = 'L',
		$w = 0,
		$h = 0,
