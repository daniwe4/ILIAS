...
trait ilFormHelper
{
	 ...
	 * @return null
	 */
	public function addSettingsFormItems(\ilPropertyFormGUI $form, array $career_goal_options, array $org_unit_options, $autocomplete_link)
	{
		...
		$si = new \ilTextInputGUI($this->txt("venue"), ilActions::F_VENUE);
		$form->addItem($si);
	 ...
	 * @return null
	 */
	public function addSettingsFormItemsUpdate(\ilPropertyFormGUI $form, array $career_goal_options, array $org_unit_options, $edit, $autocomplete_link)
	{
		require_once('Services/Form/classes/class.ilDateDurationInputGUI.php');
		...
		$ti = new \ilTextInputGUI($this->txt("venue"), ilActions::F_VENUE);
		$ti->setDisabled($edit);
		$form->addItem($ti);
