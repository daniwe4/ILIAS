...
class ilObservationsDiagrammGUI
{
	...
	public function getSVGData()
	{
		...
		$svg->setLegendParams($this->txt("ta_failed_short"), $this->settings->getLowmark(), $this->txt("ta_maybe_short"), $this->settings->getShouldSpecification(), $this->txt("ta_passed_short"), self::MAX_VALUE);
