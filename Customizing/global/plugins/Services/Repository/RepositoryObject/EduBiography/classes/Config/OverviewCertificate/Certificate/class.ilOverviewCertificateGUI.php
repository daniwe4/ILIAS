 ...
 */
class ilOverviewCertificateGUI extends ilCertificateGUI
{
    const TYPE = "xebr";
     ...
     */
    protected $settingsFormFactory;

    /**
     * @var ilCertificatePlaceholderValues
     */
    protected $placeholderValuesObject;

    /**
     * @var ilXlsFoParser|null
     */
    protected $xlsFoParser;
