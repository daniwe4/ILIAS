...
use CaT\Plugins\EduBiography\Settings\SettingsRepository as SettingsRepository;

class ilObjEduBiographyAccess extends ilObjectPluginAccess
{
    ...
    */
    ...
    {
        return !(SettingsRepository::getInstance()->loadSettings((int) $obj_id)->isOnline());
    }
}
