...
class ilTemplateRepository extends \ilCertificateTemplateRepository
{
    ...
    public function save(\ilCertificateTemplate $certificateTemplate)
    {
        ...
        $this->schedule_db->setActiveStatus($objId, (bool) $certificateTemplate->isCurrentlyActive());
    ...
    public function updateActivity(\ilCertificateTemplate $certificateTemplate, bool $currentlyActive)
    {
        ...
        $this->schedule_db->setActiveStatus((int) $certificateTemplate->getObjId(), $currentlyActive);
