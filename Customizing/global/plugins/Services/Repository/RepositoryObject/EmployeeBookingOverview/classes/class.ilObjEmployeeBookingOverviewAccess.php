 ...
 */
class ilObjEmployeeBookingOverviewAccess extends ilObjectPluginAccess
{
    /**
    ...
    {
        global $DIC;
        $settings_repo = new EBO\Settings\DBSettingsRepository($DIC['ilDB']);
        return !$settings_repo->load((int) $a_id)->isOnline();
    }
}
