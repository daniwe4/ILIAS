 ...
 */
class ilEmployeeBookingOverviewPlugin extends ilRepositoryObjectPlugin
{
    ...
    {
        return "EmployeeBookingOverview";
    }
    ...
    {
        global $DIC;
        if ($DIC['ilDB']->tableExists(EBO\Settings\DBSettingsRepository::TABLE)) {
            $DIC['ilDB']->dropTable(EBO\Settings\DBSettingsRepository::TABLE);
        }
    }
}
