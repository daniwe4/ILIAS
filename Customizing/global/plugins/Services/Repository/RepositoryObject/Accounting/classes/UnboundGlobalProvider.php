...
use \CaT\Plugins\Accounting\Mailing\MailContextAccounting;
...
class UnboundGlobalProvider extends SeparatedUnboundProvider
{
    ...
    public function buildComponentsOf($component_type, Entity $entity)
    {
        if ($component_type === TMSMailing\MailContext::class) {
            return [new MailContextAccounting($entity, $this->owner())];
        }
    ...
    public static function createGlobalProvider()
    {
        ...
        if (!$provider) {
            ...
            $provider_db->createSeparatedUnboundProvider(
                ...
                'Customizing/global/plugins/Services/Repository/RepositoryObject/Accounting/classes/UnboundGlobalProvider.php'
            );
        }
    }
