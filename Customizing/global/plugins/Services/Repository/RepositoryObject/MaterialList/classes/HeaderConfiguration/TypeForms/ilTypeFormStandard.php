...
class ilTypeFormStandard extends ilTypeForm
{
    ...
    public function initForm()
    {
        ...
        $this->form->setTitle(sprintf($this->txt("configuration_entry_set_value_title"), $this->txt("type_standard")));
        ...
        $hi->setValue(ConfigurationEntry::TYPE_STANDARD);
