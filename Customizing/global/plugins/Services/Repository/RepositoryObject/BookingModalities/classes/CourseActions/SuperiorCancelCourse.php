 ...
 */
class SuperiorCancelCourse extends TMS\CourseActionImpl
{
    use MyUsersHelper;
    ...
    public function getLink(\ilCtrl $ctrl, $usr_id)
    {
        ...
        $ctrl->setParameterByClass("ilTMSSuperiorCancelGUI", "crs_ref_id", $course->getRefId());
        $ctrl->setParameterByClass("ilTMSSuperiorCancelGUI", "usr_id", $usr_id);
        $link = $ctrl->getLinkTargetByClass(array("ilSuperiorViewGUI", "ilTMSSuperiorCancelGUI"), "start");
        $ctrl->setParameterByClass("ilTMSSuperiorCancelGUI", "crs_ref_id", null);
        $ctrl->setParameterByClass("ilTMSSuperiorCancelGUI", "usr_id", null);
