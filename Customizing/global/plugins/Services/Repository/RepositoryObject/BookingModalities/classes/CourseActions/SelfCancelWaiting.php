 ...
 */
class SelfCancelWaiting extends TMS\CourseActionImpl
{
    /**
     * @inheritdoc
     */
    ...
    public function getLink(\ilCtrl $ctrl, $usr_id)
    {
        ...
        $ctrl->setParameterByClass("ilTMSSelfCancelWaitingGUI", "crs_ref_id", $course->getRefId());
        $ctrl->setParameterByClass("ilTMSSelfCancelWaitingGUI", "usr_id", $usr_id);
        $link = $ctrl->getLinkTargetByClass(array("ilUserBookingsGUI", "ilTMSSelfCancelWaitingGUI"), "start");
        $ctrl->setParameterByClass("ilTMSSelfCancelWaitingGUI", "crs_ref_id", null);
        $ctrl->setParameterByClass("ilTMSSelfCancelWaitingGUI", "usr_id", null);
