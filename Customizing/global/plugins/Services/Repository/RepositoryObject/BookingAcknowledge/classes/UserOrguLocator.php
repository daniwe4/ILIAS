...
/**
 * Locates users and orgus visible to a viewer in the context of BookingAcknowledge.
 */
...
class UserOrguLocator
{
    ...
    /**
     * Get all orgu of user formatted to links
     *
     * @param int 	$user_id
     *
     * @return string
     */
    public function getFormattedOrgusOfUser($user_id)
    {
        $orgu_tree = $this->orgu_tree;
