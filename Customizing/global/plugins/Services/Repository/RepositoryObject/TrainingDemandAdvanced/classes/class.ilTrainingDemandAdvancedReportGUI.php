...
use CaT\Plugins\TrainingDemandAdvanced as TrainingDemandAdvanced;
use CaT\Libs\ExcelWrapper\Spout\SpoutWriter as SpoutWriter;

class ilTrainingDemandAdvancedReportGUI
{
    ...
    protected function configureFilter(TrainingDemandAdvanced\Report $report)
    {
    ...
    protected function configureTable(TrainingDemandAdvanced\Report $report)
    {
