 ...
 */
class ilAgendaItemPoolPlugin extends ilRepositoryObjectPlugin
{
    ...
    {
        if ($this->agenda_item_db === null) {
            $this->agenda_item_db = new AgendaItemPool\AgendaItem\ilDB($db);
        }

        return $this->agenda_item_db;
    }

    /**
     * Get the plugin actions
     *
     * @return AgendaItemPool\ilPluginActions
     */
    public function getActions()
    {
        if ($this->plugin_actions === null) {
            ...
            $this->plugin_actions = new AgendaItemPool\ilPluginActions(
                $this,
