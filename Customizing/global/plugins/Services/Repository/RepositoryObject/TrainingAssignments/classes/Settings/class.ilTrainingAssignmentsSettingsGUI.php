 ...
 */
class ilTrainingAssignmentsSettingsGUI
{
    ...
    public function __construct(ilObjTrainingAssignmentsGUI $parent, TrainingAssignments\ilObjActions $actions)
    {
        global $DIC;
    ...
    protected function saveProperties()
    {
        ...
        $fnc = function (AssignmentSettings $s) use ($show_info_tab) {
