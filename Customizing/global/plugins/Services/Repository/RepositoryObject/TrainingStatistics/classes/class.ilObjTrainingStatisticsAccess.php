 ...
 */
class ilObjTrainingStatisticsAccess extends ilObjectPluginAccess
{
    /**
    ...
    {
        global $DIC;
        $settings_repo = new TS\Settings\DBSettingsRepository($DIC['ilDB']);
        return !$settings_repo->load((int) $a_id)->online();
    }
}
