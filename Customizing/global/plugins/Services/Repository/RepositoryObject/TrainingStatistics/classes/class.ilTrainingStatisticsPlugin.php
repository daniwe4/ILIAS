 ...
 */
class ilTrainingStatisticsPlugin extends ilRepositoryObjectPlugin
{
    ...
    {
        global $DIC;
        if ($DIC['ilDB']->tableExists(TS\DBSettingsRepository::TABLE)) {
            $DIC['ilDB']->dropTable(TS\DBSettingsRepository::TABLE);
        }
    }
}
