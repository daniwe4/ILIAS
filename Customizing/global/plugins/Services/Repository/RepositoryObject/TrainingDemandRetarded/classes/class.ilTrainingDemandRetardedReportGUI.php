...
use CaT\Plugins\TrainingDemandRetarded as TrainingDemandRetarded;
use CaT\Libs\ExcelWrapper\Spout\SpoutWriter as SpoutWriter;

class ilTrainingDemandRetardedReportGUI
{
    ...
    /**
     * @var	TrainingDemandRetarded\Report
     */
    protected $report;
    ...
    public function __construct(
        ...
        $plugin,
        $obj_ref_id,
        TrainingDemandRetarded\Report $report
    ) {
    ...
    protected function configureFilter(TrainingDemandRetarded\Report $report)
    {
    ...
    protected function configureTable(TrainingDemandRetarded\Report $report)
    {
