 ...
 */
class ilObjTrainingDemandRetardedAccess extends ilObjectPluginAccess
{
    /**
    ...
    */
    ...
    {
        global $DIC;
        $settings_repo = new TDA\Settings\DBSettingsRepository($DIC['ilDB']);
        return $settings_repo->load((int) $a_obj_id)->online();
    }
