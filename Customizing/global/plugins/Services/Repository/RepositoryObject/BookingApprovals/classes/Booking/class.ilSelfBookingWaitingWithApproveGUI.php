 ...
 */
class ilSelfBookingWaitingWithApproveGUI extends ilBookingWithApproveGUI
{
    /**
     * @inheritdocs
     */
    ...
    {
        return $this->g_lng->txt("book_waiting_with_approval_confirm");
    }
    ...
    protected function setParameter($crs_ref_id, $usr_id)
    {
        ...
        $this->g_ctrl->setParameterByClass("ilSelfBookingWaitingWithApproveGUI", "crs_ref_id", $crs_ref_id);
        $this->g_ctrl->setParameterByClass("ilSelfBookingWaitingWithApproveGUI", "usr_id", $usr_id);
    }
    ...
    protected function getTranslations()
    {
        $trans = new \ILIAS\TMS\TranslationsImpl(
            array(
                ILIAS\TMS\Wizard\Player::TXT_TITLE => $this->g_lng->txt("booking_waiting_with_approve")
            ),
