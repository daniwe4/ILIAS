 ...
 */
class ilSuperiorBookingWaitingWithApproveGUI extends ilBookingWithApproveGUI
{
    /**
     * @inheritdocs
     */
    ...
    {
        return $this->g_lng->txt("superior_book_waiting_with_approval_confirm");
    }
    ...
    protected function setParameter($crs_ref_id, $usr_id)
    {
        ...
        $this->g_ctrl->setParameterByClass("ilSuperiorBookingWaitingWithApproveGUI", "crs_ref_id", $crs_ref_id);
        $this->g_ctrl->setParameterByClass("ilSuperiorBookingWaitingWithApproveGUI", "usr_id", $usr_id);
    }
    ...
    protected function getPlayerTitle()
    {
        ...
        return sprintf($this->g_lng->txt("booking_waiting_with_approval_for"), ilObjUser::_lookupFullname($usr_id));
    }
}
