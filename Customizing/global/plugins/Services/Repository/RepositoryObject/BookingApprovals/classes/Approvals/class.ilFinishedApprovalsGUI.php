 ...
 */
class ilFinishedApprovalsGUI extends ApprovalGUI
{
    const TEMPLATE_NAME = "tpl.approvals_overview.html";
    const TABLE_TITLE = "finished_approvals_list";
    const TABLE_TITLE_USER = "my_finished_approvals_list";
    //const MULTI_ACTIONS = false;
    const APPROVER_ACTIONS = false;
    const REQUESTER_ACTIONS = false;
    const TABLE_ID = "finished_approvals";
    const TABLE_ID_SUPERIOR = "finished_approvals_superior";
    ...
    public function executeCommand()
    {
        ...
        $this->command = $cmd;
        switch ($cmd) {
            case self::CMD_SHOW_FINISHED_APPROVALS:
                $this->$cmd();
                break;
            default:
    ...
    public function showFinishedApprovals()
    {
        $table = $this->getTable();
