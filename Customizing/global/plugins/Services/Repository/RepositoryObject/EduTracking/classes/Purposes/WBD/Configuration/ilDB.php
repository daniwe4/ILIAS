...
/**
 * Implementation for ILIAS of WBD DB interface
 *
...
class ilDB implements DB
{
    ...
    {
        $query = "SELECT id, available, contact, user_id" . PHP_EOL
        ...
        return new ConfigWBD((int) $row["id"], (bool) $row["available"], $row["contact"], (int) $row["user_id"]);
    }
