 ...
 */
class ilObjCancellationFeeReportAccess extends ilObjectPluginAccess
{
    /**
    ...
    {
        return !ilCancellationFeeReportPlugin::dic()['Settings.SettingsRepository']->load($a_id)->online();
    }
}
