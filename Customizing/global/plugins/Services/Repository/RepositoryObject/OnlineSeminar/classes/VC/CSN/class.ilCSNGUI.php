...
use \CaT\Plugins\OnlineSeminar\VC\CSN;
...
class ilCSNGUI
{
    ...
    public function __construct(\ilParticipantGUI $parent, CSN\ilActions $vc_actions, \CaT\Plugins\OnlineSeminar\ilActions $actions)
    {
        $this->parent = $parent;
