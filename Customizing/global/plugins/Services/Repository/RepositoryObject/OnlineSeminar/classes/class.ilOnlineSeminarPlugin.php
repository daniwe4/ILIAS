...
use \CaT\Plugins\OnlineSeminar\ilPluginActions;
use \CaT\Plugins\OnlineSeminar\DI;
use \CaT\Plugins\OnlineSeminar\UnboundGlobalProvider;

/**
 * Plugin base class. Keeps all information the plugin needs
 */
class ilOnlineSeminarPlugin extends ilRepositoryObjectPlugin
{
    use DI;
    ...
    public function handleEvent($a_component, $a_event, $a_parameter)
    {
        if ($a_component === 'Services/AccessControl'
            ...
            $webs = $this->getAffectedOnlineSeminar($obj_id);
    ...
    /**
     * Get all online seminar objects below the course
     *
     * @return \ilObjOnlineSeminar[]
     */
    protected function getAffectedOnlineSeminar($obj_id)
    {
        global $DIC;
    ...
    public function getReminderSettings() : \CaT\Plugins\OnlineSeminar\Config\Reminder\NotFinalized
    {
        global $DIC;
