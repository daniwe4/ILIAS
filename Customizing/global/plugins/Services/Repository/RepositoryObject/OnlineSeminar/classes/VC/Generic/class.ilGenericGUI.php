...
use \CaT\Plugins\OnlineSeminar\VC\Generic;
...
class ilGenericGUI
{
    ...
    /**
     * @var Generic\ilActions
     */
    protected $vc_actions;

    /**
     * @var \CaT\Plugins\OnlineSeminar\ilActions
     */
    protected $actions;
    ...
    public function __construct(\ilParticipantGUI $parent, Generic\ilActions $vc_actions, \CaT\Plugins\OnlineSeminar\ilActions $actions)
    {
        $this->parent = $parent;
    ...
    /**
     * Show members of Generic VC and their lp
     *
     * @return null
     */
    protected function showParticipants()
    {
        $table = new Generic\ilGenericTableGUI($this, $this->vc_actions, $this->actions, self::CMD_SHOW_PARTICIPANTS);
     ...
     * Create table filter
     *
     * @param Generic\ilGenericTableGUI 	$table
     *
     * @return null
     */
    protected function fillFilterItem(Generic\ilGenericTableGUI $table)
    {
