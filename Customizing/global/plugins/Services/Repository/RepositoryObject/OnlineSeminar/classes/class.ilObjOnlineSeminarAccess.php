 ...
 */
class ilObjOnlineSeminarAccess extends ilObjectPluginAccess
{
    /**
    ...
    */
    public function _checkAccess($a_cmd, $a_permission, $a_ref_id, $a_obj_id, $a_user_id = "")
    {
        ...
        * We rely on standard ilAccess::checkAccessOfUser procedure, i.e. return true here, except when the object is offline,
