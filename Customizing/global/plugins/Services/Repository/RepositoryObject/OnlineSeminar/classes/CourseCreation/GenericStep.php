...
namespace CaT\Plugins\OnlineSeminar\CourseCreation;
...
class GenericStep extends \CourseCreationStep
{
    ...
    {
        return $this->txt("online_seminar");
    }
    ...
    {
        return $this->txt("online_seminar_desc");
    }
    ...
    {
        $online_seminar = \ilObjectFactory::getInstanceByRefId((int) $data[self::F_OBJECT_REF_ID]);
