 ...
 */
class ilObjOnlineSeminarListGUI extends ilObjectPluginListGUI
{
    /**
    ...
    */
    public function getProperties()
    {
        ...
        require_once(__DIR__ . "/class.ilObjOnlineSeminarAccess.php");
        if (ilObjOnlineSeminarAccess::_isOffline($this->obj_id)) {
            ...
            $props[] = array("alert" => true, "property" => $object->pluginTxt("online_status"),
                "value" => $object->pluginTxt("online_seminar_offline"));
        }
