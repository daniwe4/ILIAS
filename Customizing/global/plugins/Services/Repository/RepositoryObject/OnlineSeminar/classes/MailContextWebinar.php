...
class MailContextOnlineSeminar extends \ilTMSMailContextEnte
{
    protected static $PLACEHOLDERS = array(
        'ONLINE_SEMINAR_LINK' => 'placeholder_desc_link',
        'ONLINE_SEMINAR_LOGIN_TRAINER' => 'placeholder_desc_login_trainer',
        'ONLINE_SEMINAR_PASSWORD' => 'placeholder_desc_password',
        'ONLINE_SEMINAR_PASSWORD_TRAINER' => 'placeholder_desc_password_trainer',
        'ONLINE_SEMINAR_PIN' => 'placeholder_desc_pin'
    );
    ...
    protected function resolveValueFor($id, $contexts)
    {
        ...
        if ($settings->getVCType() === 'Generic') {
            switch ($id) {
                case 'ONLINE_SEMINAR_PASSWORD':
                    return $vcsettings->getPassword();
                    break;
                case 'ONLINE_SEMINAR_LOGIN_TRAINER':
                    return $vcsettings->getTutorLogin();
                    break;
                case 'ONLINE_SEMINAR_PASSWORD_TRAINER':
