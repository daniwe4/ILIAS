 ...
 */
class ilStatusMailsUserActivities extends \ilCronJob
{
    use CommonJobFunctions;

    const ID = 'statusmail_user_activities';
    ...
    protected function getActivityData(array $usr_ids) : array
    {
        ...
        return $this->history->getActivitiesByTime($start, $end, $usr_ids);
    }
    ...
    {
        return $this->txt('stat_user_activities_title');
    }

    public function getDescription()
    {
        return $this->txt('stat_user_activities_description');
    }
}
