...
class ilReopenCourseMemberWebinarGUI
{
	const CMD_SHOW = "show";
	const CMD_REOPEN_WEBINAR = "reopenWebinar";
	const CMD_CANCEL = "cancel";

	const F_REF_ID = "ref_id";
	const F_REASON = "reason";
	const ACTION = "reopen_course_member_webinar";
	...
	protected function getForm() : ilPropertyFormGUI
	{
		...
		$form->setTitle($this->txt("reopen_course_member_webinar"));
		...
		$form->addCommandButton(self::CMD_REOPEN_WEBINAR, $this->txt('update'));
		$form->addCommandButton(self::CMD_SHOW, $this->txt('cancel'));

		return $form;
	}

	protected function reopenWebinar()
	{
		$post = $_POST;
