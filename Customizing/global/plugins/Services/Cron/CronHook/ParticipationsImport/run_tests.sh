...
PLUGINPATH='Customizing/global/plugins/Services/Cron/CronHook/ParticipationsImport';
...
if [ $1 ] ; then
	...
	phpunit --bootstrap ./$PLUGINPATH/vendor/autoload.php --group needsInstalledILIAS $PLUGINPATH/tests
fi
