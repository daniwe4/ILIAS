...
use CaT\Plugins\ParticipationsImport\DataSources\Course;

class DataSourcesCourseTest extends TestCase
{
    public function test_init_and_read()
    {
        ...
        $this->assertEquals($crs->title(), 'title');
        $this->assertEquals($crs->crsId(), 'crs_id');
