...
class InsertSessionTestObject extends InsertSessionDigester
{
    /**
     * @var Mocks
     */
...
class InsertSessionDigesterTest extends TestCase
{
    /**
     * @var InsertSessionTestObject
     */
    protected $obj;
    ...
    {
        $this->obj = new InsertSessionTestObject();
        $this->mocks = new Mocks();
    }
