...
namespace CaT\Plugins\Venues\Tags\Search;
...
{
    const TABLE_NAME = "search_tags";
    const TABLE_ALLOCATION = "search_tags_venue";
    ...
    public function getUsedSearchTagsRaw() : array
    {
        $query = "SELECT tag.id, tag.name" . PHP_EOL
