...
class TMSFilterTest extends TestCase
{
    ...
    public function test_dateperiod_overlaps_predicate()
    {
        ...
        $this->assertTrue($interpreter->interpret(
            $predicate,
            array( "start_field" => new \DateTime("1999-05-04")
        ...
        $this->assertTrue($interpreter->interpret(
            $predicate,
            array( "start_field" => new \DateTime("2000-05-04")
                    , "end_field" => new \DateTime("2001-05-04")
                    )
        ));
        ...
        $this->assertFalse($interpreter->interpret(
            $predicate,
            array( "start_field" => new \DateTime("2001-05-04")
        ...
        $this->assertFalse($interpreter->interpret(
            $predicate,
            array( "start_field" => new \DateTime("1998-05-04")
    ...
    public function test_sequence_filters_predicate()
    {
        ...
        $this->assertTrue($interpreter->interpret($pred, array( "dt_l" => new \DateTime("1985-05-04")
                            , "dt_r" => new \DateTime("2015-05-04")
                            , "text1" => "foo"
                            , "text2" => "bar"
                            )));
        $this->assertFalse($interpreter->interpret($pred, array( "dt_l" => new \DateTime("1985-05-04")
                            , "dt_r" => new \DateTime("2015-05-04")
                            , "text1" => "foobar"
                            , "text2" => "bar"
                            )));
