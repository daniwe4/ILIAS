...
$component_0 = new ILIAS\Core\Tests\Dependencies\Scenario3\ComponentA();
...
$component_1 = new ILIAS\Core\Tests\Dependencies\Scenario3\ComponentB();

$implement_1 = new ILIAS\Core\Dependencies\RenamingDIC(new Pimple\Container());
$use = new Pimple\Container();
$use[ILIAS\Core\Tests\Dependencies\Scenario3\Service::class] = fn() => $implement_0[ILIAS\Core\Tests\Dependencies\Scenario3\Service::class . "_0"];
