    ...
    public function scenarios()
    {
        return [
            ...
            "use dependency" => ["scenario3.php", "result3.php",
                [
                    \ILIAS\Core\Tests\Dependencies\Scenario3\ComponentA::class,
                    \ILIAS\Core\Tests\Dependencies\Scenario3\ComponentB::class
                ]
            ],
            "seek dependency" => ["scenario4.php", "result4.php",
                [
                    \ILIAS\Core\Tests\Dependencies\Scenario4\ComponentA::class,
                    \ILIAS\Core\Tests\Dependencies\Scenario4\ComponentB::class,
                    \ILIAS\Core\Tests\Dependencies\Scenario4\ComponentC::class
                ]
            ]
        ];
    }
